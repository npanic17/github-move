...
namespace SalonAutomobila.Controllers
{
    public class ManufacturersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Country,City")] Manufacturer manufacturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Country,City")] Manufacturer manufacturer)
        {
            if (ModelState.IsValid)
            {
